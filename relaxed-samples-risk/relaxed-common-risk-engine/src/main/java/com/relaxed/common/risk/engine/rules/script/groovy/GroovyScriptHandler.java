package com.relaxed.common.risk.engine.rules.script.groovy;

import com.relaxed.common.risk.engine.rules.script.RuleScriptHandler;
import com.relaxed.common.risk.engine.utils.CryptUtils;
...
public class GroovyScriptHandler implements RuleScriptHandler<GroovyParam, GroovyResult> {
	...
	public GroovyResult removeScript(GroovyParam context) {
		passedClassMap.remove(CryptUtils.md5(context.getScript()));
		return new GroovyResult();
	}
